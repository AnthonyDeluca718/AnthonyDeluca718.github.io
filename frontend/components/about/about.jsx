    ...
    return(
      <div className="profile-section">
        <div className="profile-info">
          <h2>About me</h2>
          <p>I am a software engineer primarily working in Javascript, React, Ruby and Rails.<br />
            I'm interested in web development, algorithms, mathematics and game design.
            I studied mathematics at Penn State and web development at App Academy. <br/>
